...
const LeftSidebar = ({ links }: LProps) => {
  return (
    <div className="flex h-screen sticky top-0 w-[20%] flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white pl-6">
      <div className="flex justify-between h-16 shrink-0 items-center pr-4">
        ...
        <span className="p-2 rounded-sm hover:bg-gray-50 cursor-pointer">
